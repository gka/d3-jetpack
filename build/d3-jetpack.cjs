// https://github.com/gka/d3-jetpack#readme Version 2.3.0-0. Copyright 2026 Gregor Aisch.
(function (global, factory) {
  ...
  function insert(name, before) {
    var n = parseAttributes(name),
        create = d3Selection.creator(n.tag),
        select = before == null ? constantNull : typeof before === "function" ? before : d3Selection.selector(before);
